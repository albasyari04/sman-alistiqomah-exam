...
const SECTIONS = [
  {
    title: 'Aplikasi',
    items: [
      { key: 'notifikasi', label: 'Notifikasi', desc: 'Atur pemberitahuan yang Anda terima', Icon: BellIcon2, route: 'NotifikasiSetting' },
      { key: 'preferensi', label: 'Preferensi Tampilan', desc: 'Tema dan tampilan aplikasi', Icon: PaletteIcon, route: 'PreferensiTampilan' },
    ],
  },
  {
    title: 'Bantuan',
    items: [
      { key: 'bantuan', label: 'Pusat Bantuan', desc: 'FAQ dan panduan penggunaan', Icon: QuestionCircleIcon, route: 'PusatBantuan' },
      { key: 'tentang', label: 'Tentang Aplikasi', desc: 'Versi aplikasi dan informasi lainnya', Icon: InfoCircleIcon, route: 'TentangAplikasi' },
    ],
  },
]
  ...
  return (
    <View style={styles.wrapper}>
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        <Text style={styles.headerName}>{profile?.full_name || 'Guru'}</Text>
...
const styles = StyleSheet.create({
  ...
  headerName: { fontSize: 18, fontWeight: '800', color: '#12251A', marginBottom: 2 },
  headerEmail: { fontSize: 12.5, color: '#8A8A8A', marginBottom: 20 },
